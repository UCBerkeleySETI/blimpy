...
def make_h5_file(filename,out_dir='./', new_name=None):
...
def cmd_tool():
    ...
    p.add_option('-n', '--new_name', dest='new_name', type='str', default='', help='New name. Default: replaces extention to .h5')
    ...
    make_h5_file(filename, out_dir = opts.out_dir, new_name=opts.new_name)
